...
bike_sales <- as.tibble(bike_sales)
...
ggplot(data = mth_bike_sales, mapping = aes(x = month, y = total, group = year)) +
  geom_area(position = 'stack', aes(fill = year))
...
#show the ets forecasts residuals
